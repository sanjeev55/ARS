...
<body>
<g:form method="post" controller="flight" action="searchBySourceAndDestination1">
    Enter the source:
    <select name="source">
...
<!-- You only need this form and the form-basic.css -->
    ...
    <g:form class="form-basic" method="post" controller="flight" action="searchBySourceAndDestination1">
