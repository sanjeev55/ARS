...
<body>
<g:form method="post" controller="flight" action="searchBySourceDateAndDestination1">
...
<!-- You only need this form and the form-basic.css -->
    ...
    <g:form class="form-basic" method="post" controller="flight" action="searchBySourceDateAndDestination1">
